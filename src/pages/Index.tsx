    ...
    <div className="min-h-screen bg-[#07080D] font-golos text-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-[#07080D]/90 backdrop-blur-xl border-b border-white/5 py-3" : "py-6"}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#00F5FF] to-[#BF5FFF]" />
          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#00F5FF] to-[#BF5FFF] shadow-[0_0_20px_rgba(0,245,255,0.3)]" />
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, i) => (
              <AnimatedSection key={i}>
                <div className="group relative p-7 rounded-2xl border border-white/8 bg-[#0D0F1A] hover:border-white/20 transition-all duration-400 overflow-hidden">
                  <div
                  ...
                  />
                  <div className="w-12 h-12 rounded-xl mb-5" style={{ background: `${s.color}15`, border: `1px solid ${s.color}30` }} />
      ...
      {/* ABOUT */}
      <section className="py-28 px-6 bg-[#0D0F1A]/40">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col gap-4">
                {[70, 60, 75].map((w, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-5 h-5 rounded-full bg-[#AAFF00]/20 border border-[#AAFF00]/40 flex-shrink-0" />
            ...
            <AnimatedSection>
              <div className="relative rounded-3xl overflow-hidden bg-[#0D0F1A] border border-white/8 aspect-square max-w-md mx-auto lg:max-w-none">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 p-12">
                  <div className="absolute top-6 right-6 w-16 h-16 rounded-2xl bg-[#AAFF00]/10 border border-[#AAFF00]/20 animate-float" />
                  <div className="absolute bottom-8 left-8 w-14 h-14 rounded-xl bg-[#BF5FFF]/15 border border-[#BF5FFF]/25 animate-float" style={{ animationDelay: "2s" }} />
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#00F5FF]/20 to-[#BF5FFF]/20 border border-white/10 animate-spin-slow">
                    <div className="w-full h-full rounded-full bg-[#07080D]/80" />
                  </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3">
              <AnimatedSection>
                <div className="bg-[#0D0F1A] rounded-3xl border border-white/8 p-8 flex flex-col gap-5">
                  <div className="w-full h-12 bg-white/5 border border-white/10 rounded-xl" />
                  <div className="w-full h-12 bg-white/5 border border-white/10 rounded-xl" />
                  <div className="w-full h-28 bg-white/5 border border-white/10 rounded-xl" />
                  <div className="w-full h-14 rounded-xl bg-gradient-to-r from-[#00F5FF]/30 to-[#BF5FFF]/30 border border-white/10" />
                </div>
              </AnimatedSection>
            </div>

            <div className="lg:col-span-2 flex flex-col gap-5">
              {["#00F5FF", "#BF5FFF", "#AAFF00", "#FF6B6B"].map((c, i) => (
                <AnimatedSection key={i}>
                  <div className="flex items-start gap-4 p-5 rounded-2xl bg-[#0D0F1A] border border-white/8">
                    <div className="w-10 h-10 rounded-xl flex-shrink-0" style={{ background: `${c}15`, border: `1px solid ${c}25` }} />
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="w-6 h-6 rounded bg-gradient-to-br from-[#00F5FF] to-[#BF5FFF]" />
          <div className="w-40 h-2 rounded-full bg-white/10" />
          <div className="w-4 h-4 rounded bg-[#00F5FF]/20" />
        </div>
      </footer>
    </div>
  );
